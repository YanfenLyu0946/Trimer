...
#create flag
				...
				#	changecol_jl=$(awk '$4=="'"$flagcol_j"'"&&$106=="'"$flagcol_l"'"{print NR}' ${temp}_${j}_${l}_.txt)
                                        changecol_jl=$(awk '$4=="'"$flagcol_j"'"&&$73=="'"$flagcol_l"'"{print NR}' ${temp}_${j}_${l}_.txt)
...
#				awk '{print $1,$3,$17,$2,$16,$4,$18,$5,$6,$12,$14,$13,$8,$9,$10,$11,$19,$20,$26,$28,$27,$22,$23,$24,$25,$29}' ${temp}_${j}_${l}.txt >${temp}_${j}_${l}_output.txt
				awk '{print $1,$3,$72,$2,$71,$4,$73,$5,$6,$12,$14,$13,$8,$9,$10,$11}' ${temp}_${j}_${l}.txt >${temp}_${j}_${l}_output_1.txt
	#			awk 'for(i=1;i<113;i++){print $i}' ${temp}_${j}_${l}.txt >${temp}_${j}_${l}_output_2.txt
				cut -d ' ' -f 15-69 ${temp}_${j}_${l}.txt >${temp}_${j}_${l}_output_2.txt
				awk '{print $74,$75,$81,$83,$82,$77,$78,$79,$80}' ${temp}_${j}_${l}.txt >${temp}_${j}_${l}_output_3.txt
#				awk 'for(i=117;i<=NF;i++){print $i}' ${temp}_${j}_${l}.txt >${temp}_${j}_${l}_output_4.txt
				cut -d ' ' -f 84- ${temp}_${j}_${l}.txt >${temp}_${j}_${l}_output_4.txt
